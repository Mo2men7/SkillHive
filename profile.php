      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <h5 class="my-3"><?php echo $dataFirstName." ".$dataLastName ?></h5>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?php echo $dataFirstName." ".$dataLastName ?></p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">http://lol.me</p>
              </div>
            </div>
            <hr>
            <div class="row">
